...
from .views import admin_view, student_view, teacher_view, parent_view, pending_view, login_redirect, StudentListView, StudentDetailView, StudentCreateView, StudentUpdateView, StudentDeleteView, ParentListView, ParentDetailView, ParentCreateView, ParentUpdateView, ParentDeleteView, GradeListView, GradeDetailView, GradeCreateView, GradeUpdateView, GradeDeleteViewi, TeacherListView, TeacherDetailView, TeacherCreateView, TeacherUpdateView, TeacherDeleteView, SubjectListView, SubjectDetailView, SubjectCreateView, SubjectUpdateView, SubjectDeleteView, PerformanceListView, performanceDetailView, PerformanceCreateView, PerformanceUpdateView, PerformanceDeleteView, AttendanceListView, AttendanceDetailView, AttendanceCreateView, AttendanceUpdateView, AttendanceDeleteView, InvoiceListView, InvoiceDetailView, InvoiceCreateView, InvoiceUpdateView, InvoiceDeleteView, PaymentListView, PaymentDetailView, PaymentCreateView, PaymentUpdateView, PaymentDeleteView, EnrollmentListView, EnrollmentDetailView, EnrollmentCreateView, EnrollmentUpdateView, EnrollmentDeleteView
