...
from .views import admin_view, student_view, teacher_view, parent_view, StudentListView, StudentDetailView, StudentCreateView, StudentUpdateView, StudentDeleteView
# from . import views
